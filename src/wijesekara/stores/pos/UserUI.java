...
public class UserUI extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(confirm_pass, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                                    .addComponent(new_pass)
                                    .addComponent(old_pass)))
                            .addComponent(jLabel1)))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(pass_btn)))
                .addGap(73, 73, 73))
        );
    ...
    private void pass_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pass_btnActionPerformed
        MD5Converter md5 = new MD5Converter();
        if (!old_pass.getText().trim().equals("") || !new_pass.getText().trim().equals("") || !confirm_pass.getText().trim().equals("")) {
            if (new_pass.getText().trim().equals(confirm_pass.getText().trim())) {
                String oldPassword = md5.md5(old_pass.getText().trim());
                String newPassword = md5.md5(new_pass.getText().trim());
    ...
    }//GEN-LAST:event_pass_btnActionPerformed
